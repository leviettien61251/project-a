...
<div className="flex h-[6rem] items-center bg-black">
        {/* Menubar  */}

        <Menubar
          className={cn(
            "mr-auto ml-auto flex h-[4rem] w-fit flex-row gap-6 bg-inherit",
            "",
          )}
        >
          <MenubarMenu>
            {/* 1 */}
            <MenubarTrigger>Nguyên liệu pha chế</MenubarTrigger>
            <MenubarPortal>
              <MenubarContent>
                <MenubarItem>Chi tiết 1</MenubarItem>
                <MenubarItem>Chi tiết 2</MenubarItem>
                <MenubarItem>Chi tiết 3</MenubarItem>
              </MenubarContent>
            </MenubarPortal>
          ...
          <MenubarMenu>
            <MenubarTrigger>Tất cả sản phẩm</MenubarTrigger>
            <MenubarContent>
              <MenubarItem>Chi tiết 1</MenubarItem>
              <MenubarItem>Chi tiết 2</MenubarItem>
              <MenubarItem>Chi tiết 3</MenubarItem>
          ...
          <MenubarMenu>
            <MenubarTrigger>Dịch vụ setup</MenubarTrigger>
          </MenubarMenu>
          <MenubarMenu>
            <MenubarTrigger>Công thức</MenubarTrigger>
          </MenubarMenu>
          <MenubarMenu>
            <MenubarTrigger>Giới thiệu & Liên hệ</MenubarTrigger>
          </MenubarMenu>
        </Menubar>
        ...
        {/* <NavigationMenu>
          <NavigationMenuItem>
            ...
            <NavigationMenuContent>
              <ul className="grid list-none grid-flow-row grid-cols-2 w-[20rem] h-[10rem] ">
                <li>qq</li>
                <li>qq</li>
                <li>qq</li>
                <li>qq</li>
          ...
          <NavigationMenuItem>
            <NavigationMenuTrigger>Product2</NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid list-none grid-flow-row grid-cols-2">
                <li>qqsssssssssssssssss</li>
                <li>qq</li>
                <li>qq</li>
                <li>qq</li>
                <li>ww</li>
